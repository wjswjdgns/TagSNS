...
class MemberRepositoryTest {
    ...
    public void testfollow() throws Exception{
        ...
        // 저장
        memberRepository.saveFollow(follow1);
        memberRepository.saveFollow(follow2);
        memberRepository.saveFollow(follow3);

        List<Follow> responseMembers = memberRepository.getResponseMember(memberId); // 나를 등록한 사람
        List<Follow> requestMembers = memberRepository.getRequestMember(memberId); // 내가 등록한 사람
